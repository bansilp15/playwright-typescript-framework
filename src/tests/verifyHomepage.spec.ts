...
test('Verify HomePage text', async({ page }) => {
    ...
    test.step('Homepage has correct title', async () => {
        await expect(page).toHaveTitle('Restful-booker-platform demo');
    });

    test.step('Homepage text is correct', async () => {
    ...
    test.step('Homepage menu items are correct', async () => {
...
test('Verify Contact Information', async ({ page }) => {
    ...
    test.step('Address is correct', async() =>{
...
test('Verify able to change Check in and Check out dates', async ({ page }) => {
    ...
    test.step('Verify correct check in and check out dates are set', async() => {
    ...
    test.step('Click Book Now button', async() =>{
